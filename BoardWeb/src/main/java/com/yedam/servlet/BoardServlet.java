...
//		System.out.println("service 메소드 호출.");
		...
		//요청페이지 ?bno=2
		String boardNo=req.getParameter("bno");//중요
...
//		mapper.updateReadCnt(Integer.parseInt(boardNo));//카운트 증가
		...
		str += "<tr><th>작성일지</th><td colspan='3'>" + sdf.format(board.getWriteDate()) + "</td></tr>";
		str += "</tbody></table>";
